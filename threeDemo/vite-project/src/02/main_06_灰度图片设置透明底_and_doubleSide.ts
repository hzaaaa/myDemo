...
console.log('uv',boxGeometry.attributes.uv);
const textureLoader = new THREE.TextureLoader();
let defaultTexture = textureLoader.load('/img/default.jpg');
let px_19 = textureLoader.load('/img/px_19.png');
let alphaTexture = textureLoader.load('/img/alpha.webp');
...
px_19.magFilter = THREE.NearestFilter
